...
cols_exibir = [
    "ordem_operacoes", "fonte", "Tipo_operacao", "Dt_doc", "Dt_e_s", 
    "Qtd", "q_conv", "__qtd_decl_final_audit__", "saldo_estoque_anual", 
    "entr_desac_anual", "descr_padrao", "unid_ref"
]
...
if arq_aba_anual.exists():
    ...
    if not df_anual_2021.is_empty():
        ...
        saidas_calc_esperado = estoque_inicial + entradas + entradas_desacob - estoque_final
        ...
        print(f"\n=== EQUAÇÃO DE SALDO ===")
        print(f"estoque_inicial + entradas - saidas + entradas_desacob = {estoque_inicial + entradas - saidas + entradas_desacob}")
        print(f"estoque_final = {estoque_final}")
        print(f"Diferença (deve ser 0): {estoque_inicial + entradas - saidas + entradas_desacob - estoque_final}")
else:
