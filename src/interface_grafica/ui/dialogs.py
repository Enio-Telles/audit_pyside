...
class DialogoSelecaoConsultas(QDialog):
    ...
    def __init__(self, consultas: list[Path], parent=None, pre_selecionados: list[str] | None = None) -> None:
        ...
        # Se houver pre_selecionados, o checkbox "Selecionar todas" começa desmarcado se algum faltar
        ...
        for sql_path in consultas:
            ...
            # Se pre_set é None (primeira vez ou reset), marca tudo. 
            # Senão, marca apenas se estiver no set.
