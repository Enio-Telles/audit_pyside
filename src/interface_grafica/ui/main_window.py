...
class MainWindow(SqlQueryControllerMixin, ConversaoControllerMixin, AgregacaoControllerMixin, ConsultaControllerMixin, IdAgrupadosControllerMixin, AgregacaoWindowMixin, AuditoriaControllerMixin, AuditoriaWindowMixin, ImportacaoControllerMixin, ImportacaoWindowMixin, QMainWindow):
