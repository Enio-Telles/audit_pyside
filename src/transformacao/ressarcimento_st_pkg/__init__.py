...
from transformacao.ressarcimento_st_pkg.ressarcimento_st_mensal import (
    gerar_ressarcimento_st_mensal,
)


def executar_pipeline_ressarcimento_st(
    ...
    ok_conc = (
        gerar_ressarcimento_st_conciliacao(cnpj, pasta_cnpj) if ok_mensal else False
    )
