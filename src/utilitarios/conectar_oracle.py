...
try:
    ...
    rprint(
        "[red]Erro na configuração das variáveis de rede Oracle. Verifique o arquivo .env.[/red]"
    )
...
def obter_conexao_oracle(user=None, password=None):
    ...
    try:
        ...
        try:
            ...
            rprint(
                "[yellow]Aviso: Ocorreu um erro ao tentar fechar a conexão com o banco de dados.[/yellow]"
            )
...
if __name__ == "__main__":
    try:
        ...
        rprint(
            "[red]Falha no teste de conexão. Verifique as credenciais e as configurações de rede.[/red]"
        )
