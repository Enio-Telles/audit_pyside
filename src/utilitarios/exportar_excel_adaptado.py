...
def _detectar_preset(nome_base: str, df_pd: pd.DataFrame) -> str:
    ...
    if {"tipo_operacao", "chv_nfe", "num_item", "cod_item", "id_agrupado", "score_vinculo_xml"}.issubset(cols):
        return "c170_xml"
    ...
    presets = {
        ...
        "c170_xml": {
            **base,
            "zoom": 82,
            "texto_forcado": base["texto_forcado"] | {
                "tipo_operacao", "nsu", "chv_nfe", "mod", "ser", "num_nfe",
                "finnfe", "co_uf_emit", "co_uf_dest", "cod_item", "cod_barra",
                "ncm", "cest", "tipo_item", "cfop", "cst", "unid", "id_agrupado",
                "regra_vinculo_xml", "fonte_xml", "cod_item_c170_ref",
            ...
            "decimal_cols": {
                "qtd", "vl_item", "aliq_icms", "vl_bc_icms", "vl_icms",
                "vl_icms_st", "vl_bc_icms_st", "aliq_st", "score_vinculo_xml",
                "desc_similarity", "diff_qtd", "diff_vl_total", "diff_vl_unit",
                "it_pc_interna", "it_pc_mva", "it_pc_reducao"
            },
            "date_cols": {"dt_doc", "dt_e_s"},
            "boolean_cols": {
                "match_xml", "it_in_st", "it_in_mva_ajustado", "it_in_isento_icms",
                "it_in_combustivel", "it_in_pmpf", "it_in_reducao_credito"
            },
            "larguras_fixas": {
                "tipo_operacao": 18, "nsu": 16, "chv_nfe": 48, "mod": 10, "ser": 10,
                "num_nfe": 14, "dt_doc": 12, "dt_e_s": 12, "num_item": 10, "finnfe": 10,
                "co_uf_emit": 10, "co_uf_dest": 10, "cod_item": 18, "cod_barra": 18,
                "ncm": 12, "cest": 12, "tipo_item": 10, "descr_item": 40, "descr_compl": 30,
                "cfop": 10, "cst": 10, "qtd": 12, "unid": 10, "vl_item": 14,
                "aliq_icms": 10, "vl_bc_icms": 14, "vl_icms": 14, "vl_icms_st": 14,
                "vl_bc_icms_st": 14, "aliq_st": 10, "id_agrupado": 18, "co_sefin_final": 12,
                "co_sefin_agr": 12, "score_vinculo_xml": 14, "desc_similarity": 12,
                "diff_qtd": 12, "diff_vl_total": 14, "diff_vl_unit": 14,
                "regra_vinculo_xml": 24, "fonte_xml": 12, "cod_item_c170_ref": 18,
                "cod_item_xml_escolhido": 18, "num_item_c170_ref": 12, "num_item_xml_escolhido": 12,
            },
            "highlight_rules": [
