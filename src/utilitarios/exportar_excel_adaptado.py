...
def _detectar_preset(nome_base: str, df_pd: pd.DataFrame) -> str:
    ...
    if {"chave_acesso", "nsu_evento", "evento_dhevento", "evento_tpevento"}.issubset(
        cols
    ):
        return "nfe_evento"
    ...
    if {"periodo_efd", "chave_saida", "cod_mot_res", "vl_ressarc_st_retido"}.issubset(
        cols
    ):
        return "c176_ressarcimento"
    ...
    if {
        "periodo_efd",
        "qtd_itens_analisados_c176",
        "diferenca_credito_proprio",
        "diferenca_st_retido",
    }.issubset(cols):
        return "c176_mensal_resumo"
    ...
    presets = {
        ...
        "c170_xml": {
            **base,
            ...
            | {
                ...
                "fonte_xml",
                "cod_item_c170_ref",
                "cod_item_xml_escolhido",
            },
            "wrap_cols": base["wrap_cols"] | {"descr_item", "descr_compl"},
            "integer_cols": {"num_item", "num_item_c170_ref", "num_item_xml_escolhido"},
            "decimal_cols": {
                "qtd",
                "vl_item",
                "aliq_icms",
            ...
            "larguras_fixas": {
                ...
                "co_sefin_final": 12,
                "co_sefin_agr": 12,
                "score_vinculo_xml": 14,
                "desc_similarity": 12,
                "diff_qtd": 12,
                "diff_vl_total": 14,
                "diff_vl_unit": 14,
                "regra_vinculo_xml": 24,
                "fonte_xml": 12,
                "cod_item_c170_ref": 18,
                "cod_item_xml_escolhido": 18,
                "num_item_c170_ref": 12,
                "num_item_xml_escolhido": 12,
            },
            "highlight_rules": [
                {"type": "boolean_true", "column": "match_xml"},
                {"type": "greater_than", "column": "score_vinculo_xml", "value": 1000},
            ],
        },
        "bloco_h_inventario": {
            **base,
            ...
            "wrap_cols": base["wrap_cols"]
            | {"mot_inv_desc", "descricao_produto", "obs_complementar"},
            "decimal_cols": {
                "valor_total_inventario_h005",
                "quantidade",
                "valor_unitario",
            ...
            "larguras_fixas": {
                ...
                "cod_mot_inv": 12,
                "mot_inv_desc": 28,
                "valor_total_inventario_h005": 18,
                "codigo_produto": 18,
                "descricao_produto": 38,
                "cod_ncm": 12,
                "cest": 12,
                "cod_barra": 18,
                "tipo_item": 12,
                ...
                "valor_unitario": 14,
                "valor_item": 14,
                "indicador_propriedade": 12,
                "participante_terceiro": 18,
                "obs_complementar": 28,
                "cst_icms": 10,
                "bc_icms": 14,
                "vl_icms": 14,
        ...
        "nfe_evento": {
            **base,
            "zoom": 90,
            "texto_forcado": base["texto_forcado"]
            | {"chave_acesso", "nsu_evento", "evento_tpevento"},
        ...
        "reg_0200_sped": {
            **base,
            ...
            "larguras_fixas": {
                ...
                "desc_tipo_item": 26,
                "cod_gen": 10,
                "descricao_cod_gen": 40,
                "cod_fin_efd": 10,
                "data_entrega_efd_periodo": 12,
            },
            "highlight_rules": [
        ...
        "c176_ressarcimento": {
            **base,
            ...
            "wrap_cols": base["wrap_cols"]
            | {"descricao_item", "descricao_motivo_ressarcimento"},
            "decimal_cols": {
                "qtd_item_saida",
                "vl_total_item",
            ...
            "larguras_fixas": {
                ...
                "vl_total_item": 14,
                "cod_mot_res": 10,
                "descricao_motivo_ressarcimento": 28,
                "chave_nfe_ultima_entrada": 48,
                "c176_num_item_ult_e_declarado": 12,
                "dt_ultima_entrada": 12,
                "vl_unit_bc_st_entrada": 14,
                "vl_unit_icms_proprio_entrada": 16,
                "vl_unit_ressarcimento_st": 16,
                "vl_ressarc_credito_proprio": 18,
                "vl_ressarc_st_retido": 16,
        ...
        "c176_mensal_resumo": {
            **base,
            ...
            "decimal_cols": {
                "total_ressarc_credito_proprio",
                "total_ajuste_credito_proprio_e111",
                "diferenca_credito_proprio",
                "total_ressarc_st_retido",
                "total_ajuste_st_retido_e111",
                "diferenca_st_retido",
                "total_ajuste_ro020050_e111",
                "total_ajuste_ro020048_e111",
            },
            "larguras_fixas": {
                "cnpj": 18,
                "periodo_efd": 10,
                "qtd_itens_analisados_c176": 12,
                "total_ressarc_credito_proprio": 18,
                "total_ajuste_credito_proprio_e111": 18,
                "diferenca_credito_proprio": 16,
                "total_ressarc_st_retido": 18,
                "total_ajuste_st_retido_e111": 18,
                "diferenca_st_retido": 16,
                "total_ajuste_ro020050_e111": 18,
                "total_ajuste_ro020048_e111": 18,
            },
            "highlight_rules": [
        ...
        "c176_v2_analitico": {
            **base,
            ...
            "larguras_fixas": {
                ...
                "c100_reg": 10,
                "cod_sit": 10,
                "descricao_cod_sit": 30,
                "ind_oper": 10,
                "oper": 12,
                "ind_emit": 10,
                "descricao_ind_emit": 18,
                "chv_nfe": 48,
                "num_doc": 16,
                "cod_part": 16,
                "dt_doc": 12,
                ...
                "descr_item": 40,
                "tipo_item": 10,
                "descricao_tipo_item": 24,
                "cod_gen": 10,
                "descricao_cod_gen": 24,
                "cod_ncm": 12,
                "cest": 12,
                "segmento_cest": 12,
                "no_segmento": 20,
                ...
                "descricao_cfop": 24,
                "cod_nat": 12,
                "descricao_cod_nat": 24,
                "cst_icms": 10,
                "descricao_cst_icms": 20,
                "aliq_icms": 10,
                "ind_mov": 10,
                "descricao_ind_mov": 18,
                "unid_inv": 10,
                "unid": 10,
                "qtd": 12,
                "vl_item": 14,
        ...
        "dados_cadastrais": {
            **base,
            ...
            "larguras_fixas": {
                ...
                "município": 18,
                "uf": 8,
                "regime de pagamento": 24,
                "situação da ie": 24,
                "data de início da atividade": 14,
                "data da última situação": 14,
                "período em atividade": 18,
                "redesim": 40,
            },
        },
        "e111_ajustes": {
            **base,
            "zoom": 88,
            "texto_forcado": base["texto_forcado"]
            | {"periodo_efd", "codigo_ajuste", "cod_fin_efd"},
        ...
        "fronteira_resumida": {
            **base,
            ...
            "larguras_fixas": {
                ...
                "qtd_comercial": 12,
                "valor_produto": 14,
                "bc_icms_st_destacado": 16,
                "icms_st_destacado": 16,
                "co_sefin": 12,
                "cod_rotina_calculo": 14,
                "valor_icms_fronteira": 16,
            },
            "highlight_rules": [
        ...
        "fronteira_completo": {
            **base,
            ...
            "wrap_cols": base["wrap_cols"]
            | {"nome_emit", "prod_xprod", "nome_co_sefin", "situação"},
            "integer_cols": {"prod_nitem"},
            "decimal_cols": {
                "prod_qcom",
                "prod_vuncom",
                ...
                "vl_tot_cred",
                "vl_icms",
                "it_pc_aliquota_interna",
                "it_pc_aliquota_origem",
                "it_pc_agregacao_interna",
                "it_pc_interna",
            },
        ...
        "mov_estoque": {
            **base,
            ...
            "texto_forcado": base["texto_forcado"]
            | {"id_agrupado", "chv_nfe", "nsu", "finnfe", "infprot_cstat", "cfop"},
        },
        "generico": base,
    }
...
def _largura_auto(
    serie: pd.Series, header: str, minimo: int = 10, maximo: int = 60
) -> int:
    try:
...
def _escolher_formato(
    col_lower: str, dtype: str, cfg: dict[str, Any], formatos: dict[str, Any]
):
    ...
    if col_lower in cfg["url_cols"]:
        return formatos["url"]
    if col_lower in cfg["texto_forcado"] or any(
        chave in col_lower
        for chave in ["codigo", "ncm", "cest", "gtin", "chave", "sefin"]
    ):
...
def _aplicar_links_url(
    ...
    for col_lower in cfg["url_cols"]:
        ...
        for row_idx, valor in enumerate(df_pd.iloc[:, col_idx], start=1):
            if isinstance(valor, str) and valor.strip().lower().startswith(
                ("http://", "https://")
            ):
                worksheet.write_url(
                    row_idx, col_idx, valor, formatos["url"], string=valor
                )
...
def exportar_excel(
    ...
    with pd.ExcelWriter(arquivo_excel, engine="xlsxwriter") as writer:
        ...
        for col_idx, col_name in enumerate(df_pd.columns):
            ...
            if largura is None:
                if col_lower in cfg["wrap_cols"] or col_lower.startswith("lista_"):
                    largura = _largura_auto(
                        df_pd[col_name], col_name, minimo=16, maximo=42
                    )
                elif col_lower in cfg["texto_forcado"] or col_lower in cfg["url_cols"]:
                    largura = _largura_auto(
                        df_pd[col_name], col_name, minimo=12, maximo=42
                    )
                elif col_lower in cfg["date_cols"] or col_lower in cfg["datetime_cols"]:
                    largura = _largura_auto(
                        df_pd[col_name], col_name, minimo=12, maximo=20
                    )
                else:
                    largura = _largura_auto(
                        df_pd[col_name], col_name, minimo=10, maximo=30
                    )
