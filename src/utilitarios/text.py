...
# ATENÇÃO:
# Toda normalização de descrição fiscal deve passar por normalize_desc()
# ou expr_normalizar_descricao(). Não criar normalizadores paralelos para descrição.
