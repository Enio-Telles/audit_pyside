...
from transformacao.rastreabilidade_produtos.produtos_agrupados import inicializar_produtos_agrupados
...
mod = importlib.import_module("transformacao.rastreabilidade_produtos.04_produtos_final")
